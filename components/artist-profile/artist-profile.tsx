  ...
  <main className="container flex flex-col">
    <section>
      <div className="grid grid-cols-6">
        <div className="col-span-6 sm:col-span-3 md:col-start-2 md:col-span-2 flex flex-col justify-center items-center px-4 order-2 sm:order-1 sm:mx-auto">
    ...
    <section className="flex overflow-x-auto space-x-4 p-4">
